...
namespace API_Layer.Controllers
{
    ...
    public class CategoryController : BaseApiController
    {
        ...
        public async Task<IActionResult> CreateCategory([FromBody] CategoryCreateDTO categoryCreateDto)
        {
            ...
            return HandleResult(result, category => CreatedAtAction(nameof(GetAllCategories), new { id = category.Id }, category));
        }
        ...
        public async Task<IActionResult> AddServiceToCategory(Guid categoryId, Guid serviceId)
        {
            ...
            var result = await _mediator.Send(command);
            return HandleResult(result, () => Ok("Service linked to category successfully."));
        }
